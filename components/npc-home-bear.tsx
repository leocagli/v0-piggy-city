...
export function NPCHomeBear({ x, y, cellW, cellH, isNearby = false }: NPCHomeBearProps) {
        ...
        >
          ...
          <div
            style={{
              ...
              boxShadow: '0 4px 0 #92400e, inset 0 -2px 0 rgba(0,0,0,0.05)',
              position: 'relative',
            }}
          >
            {/* NPC name tag */}
            ...
            >
              ¡Bienvenido a mi hogar! Aqui encontraras calidez, comodidad y los mejores momentos familiares.
            </p>
          </div>
