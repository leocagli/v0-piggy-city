...
interface NPCBusinessBearProps {
...
export function NPCBusinessBear({ x, y, cellW, cellH, isNearby = false }: NPCBusinessBearProps) {
  ...
  return (
    ...
    >
        ...
        >
          ...
          <div
            style={{
              ...
              boxShadow: '0 4px 0 #3d2714, inset 0 -2px 0 rgba(0,0,0,0.05)',
              position: 'relative',
            }}
          >
            {/* NPC name tag */}
            ...
            >
              Bienvenido al distrito de Negocios! Aqui se hacen transacciones, ofertas y grandes oportunidades.
            </p>
          </div>
      ...
      >
        <Image
          src="/npc-business-bear.png"
          alt="Business Bear NPC"
          fill
          style={{
            objectFit: 'contain',
